...
### Схема Anycast балансировки
  - BGP Anycast
    ...
    - Маршрутизаторы в интернете принимают решение о том, какой из объявленных маршрутов является наиболее предпочтительным на основе различных критериев BGP, политика локального провайдера и другие метрики.
