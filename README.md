...
| **KubeFlow**                          | ML - Управление экспериментами и моделями                                        | Ведение трекинга экспериментов, автоматизация развертывания моделей, управление моделями в production, поддержка сравнения результатов и версионирования               |
...
| Название | Хостинг | Конфигурация                                                    | Cores | Count | Покупка  | Аренда        | Покупка станет выгоднее аренды за |
| -------- | ------- | --------------------------------------------------------------- | ----- | ----- | -------- | ------------- | --------------------------------- |
| kubenode | own     | 2x6338 / 10x64GB DDR5 RAM / 8xH100 NVL GPU / 8TB NVMe / 100Gb/s | 64    | 25    | 6779300$ | 1440000$/мес. | ~5 мес.                           |
