...
| **Crowdsourcing (MTurk, Toloka)**     | Массовая разметка данных                                                         | Позволяет привлечь большое количество людей для разметки данных, полезно для масштабных проектов                                                                       |
| **Snorkel**                           | Программная разметка данных                                                      | Позволяет автоматизировать разметку больших массивов данных, снижает затраты на ручную разметку.                                                                       |
| **Dask**                              | ML - подготовка данных                                                           | Управление большими данными Эффективная обработка массивов данных, распределенное выполнение задач для LLM-проектов.                                                   |
