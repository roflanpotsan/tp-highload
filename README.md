...
- По данным OpenAI [4] размер модели GPT-3 был около 800 ГБ, размер тренировочных данных ~ 950 ГБ. Так как неизбежно будут выходить новые модели, то следует соответствующим образом рассчитать размер хранилища.
| Данные  | Объем |
| --- | --- |
